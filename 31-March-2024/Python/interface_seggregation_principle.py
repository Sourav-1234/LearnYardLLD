#Now Each of the Function in the Bank Account is divided into multiple interfaces 
#which are responsible for each action thus demonstrating the Interface Seggregation Principle
...
class InterestApplicable(ABC):
    @abstractmethod
    def apply_interest(self):
        pass


class BankAccount(Depositable,Withdrawable):
    def __init__(self):
        self.balance=0
...
class SavingsAccount(BankAccount,InterestApplicable):
